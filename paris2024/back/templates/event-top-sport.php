...
<div class="olympics_filter-events_items olympics__event olympics__event--<?php print sanitize_title( $controller->getSport( $sport_id )->sport_name ); ?>">
    <?php if ( $controller->getSport( $sport_id )->sport_name ): ?>
        <div class="olympics__event-header">
            <div class="olympics__event-header_title">
                <?php echo $controller->getSport( $sport_id )->sport_name; ?>
            </div>
        </div>
    <?php endif; ?>
                ...
                <?php foreach ( maybe_unserialize($event->custom) as $countryPair ): ?>
                    <div class="olympics__event-item <?php print sanitize_title( $event->event_type ); ?>">
                        <div class="olympics__event-item-time">
                            <?php echo mysql2date( 'd.m в H:i', $event->event_time ); ?>
